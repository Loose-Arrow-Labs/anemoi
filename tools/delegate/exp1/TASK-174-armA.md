...
The code is checked out for you at:
    ...
    C:/Users/Alex Lucero/source/repos/exp1s1-a

It is a git worktree already on branch `issue/174-explanation-inline-a`, based on current `main`.
...
When every gate passes, **commit locally and stop**. Do NOT push. Do NOT open a pull request. This
branch is evidence for a controlled experiment, not a feature to merge.
...
- HOW MANY OF THE 9 CALL SITES I TOUCHED, and which
