...
It is a git worktree already on branch `issue/174-explanation-inline-b`, based on current `main`.
...
The brief must be **400 tokens or fewer**. That is a hard limit. Roughly 300 words.
