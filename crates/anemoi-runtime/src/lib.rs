    ...
    D: serde::Deserializer<'de>,
{
    ...
    impl<'de> Visitor<'de> for ColocationSetsVisitor {
        ...
        fn expecting(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            write!(f, "a sequence of {{name, models}} objects or a name-to-expression mapping")
        }
...
fn parse_or(tokens: &[MatrixToken], pos: &mut usize, vars: &HashMap<&str, &str>) -> Vec<BTreeSet<String>> {
...
fn parse_and(tokens: &[MatrixToken], pos: &mut usize, vars: &HashMap<&str, &str>) -> Vec<BTreeSet<String>> {
...
fn parse_factor(tokens: &[MatrixToken], pos: &mut usize, vars: &HashMap<&str, &str>) -> Vec<BTreeSet<String>> {
